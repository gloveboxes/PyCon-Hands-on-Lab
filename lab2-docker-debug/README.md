...
2. [Connecting Raspberry Pi Container Application to Azure IoT DevKit](#connecting-an-mxchip-iot-devkit-device-to-your-azure-iot-central-application)
...
1. Expand the App folder, and open the app.py file.
